...
brands_of_car = {
    ...
    'Golf car': {'fuel': 25, 'strength': 15, 'consumption': 5}
}


class Human:

    def __init__(self, name="N/A", car=None,
                 home=None, job=None):
        self.name = name
        self.money = 100
        self.gladness = 50
    ...
    def days_indexes(self, day):
        day = f"Today is the {day} of {self.name}'s life"
        print(f"{day:=^50}","\n")
